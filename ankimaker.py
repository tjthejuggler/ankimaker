...
text_type_article_radiobutton = Radiobutton(textTypeFrame, text='article', variable=text_type, value='article', font=('Courier', 10))
text_type_article_radiobutton.pack(side="left")
text_type_youtube_radiobutton = Radiobutton(textTypeFrame, text='youtube', variable=text_type, value='youtube', font=('Courier', 10))
...
youtube_file_name_label.grid(row=0, column=0, sticky=E)
...
youtube_file_name_entry.grid(row=0, column=1)

youtube_file_url_label = ttk.Label(youtubeInfoFrame, text='url')
youtube_file_url_label.grid(row=1, column=0, sticky=E)
...
url_entry_button.grid(row=1, column=2)
...
destination_language_optionmenu.grid(row=1, column=1)
destination_language_optionmenu.configure(state='disable')
